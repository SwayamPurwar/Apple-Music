...
const BottomNavigation = () => {
    ...
    return (
        <div className="bottom-navigation">
            ...
            {/* UPDATED: Library Icon (Stack of albums instead of Eye) */}
            <NavItem 
                to="/library" 
                label="Library" 
                icon={
                    <svg viewBox="0 0 24 24" width="24" height="24" fill={path.includes('/library') || path.includes('/playlists') ? "currentColor" : "none"} stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M4 19.5A2.5 2.5 0 0 0 6.5 22H20V7H6.5A2.5 2.5 0 0 0 4 9.5v10z"></path>
                        <path d="M6 2h14"></path>
                        <path d="M6 5h14"></path>
                    </svg>
                }
